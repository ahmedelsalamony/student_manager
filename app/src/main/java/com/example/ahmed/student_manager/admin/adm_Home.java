package com.example.ahmed.student_manager.admin;
...
public class adm_Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adm_home_activity);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        webServices=new WebServices();
        webServices=new WebServices();
        webServices.sharedPreferences=getSharedPreferences("manager",0);
        ...
        email = (TextView) headerView.findViewById(R.id.navigation_password);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.adm__home, menu);
        return true;
    }
